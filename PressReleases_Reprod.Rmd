...
cr_drugs <- cr %>%
  mutate(cocaine = str_count(speech, regex("cocaine", ignore_case = TRUE)),
         ...
         all_opioid = str_count(speech, regex("opioid|opiate|heroin |fentanyl", ignore_case = TRUE)),
         all_drug_eps = str_count(speech, regex("opioid|opiate| meth |methamphetamine|cocaine|heroin |fentanyl", ignore_case = TRUE)))
