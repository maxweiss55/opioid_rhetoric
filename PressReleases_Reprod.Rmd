...
#Remember, "Dictionary_ALL.xlsx" must be in the working directory for the function to work.
#Additionally, this function seems to work best after clearing one's R environment for whatever reason
speech_matrix <- score_matrix(df)
#If function worked correctly, "speech_matrix" should contain 17,024 rows.
#Metadata about each speech in Congressional Record Drug Speeches dataset fed into the function are retained

#Speech and Member Scoring -  speeches with no informative terms (NA) removed
#Score speeches
